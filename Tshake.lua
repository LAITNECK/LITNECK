...
local keko222 = 'http://tshake.team/hack.php?channle='..database:get("keko:ch:username:"..bot_id)..'&id='..msg.sender_user_id_
local ress = http.request(keko222)
if ress then
...
local user_msgs = database:get('tshake:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
local edit = database:get('tshake:'..bot_id..'user:editmsg'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local msguser = tonumber(database:get('tshake:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_))
...
🦁┇<a href="https://telegram.me/ikekoi">قناه السورس</a>
📜┇<a href="https://telegram.me/botlua">قناه شروحات سورس</a>
📁┇<a href="https://telegram.me/TshAkEfiles">قناه ملفات السورس</a>

🔎┇<a href="https://t.me/ikekoi/1">طريقه التنصيب</a>

📮┇<a href="t.me/ikekobot">لـ تواصل </a> 
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
